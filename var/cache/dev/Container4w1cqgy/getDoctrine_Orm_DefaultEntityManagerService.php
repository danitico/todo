...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\TaskRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\TaskRepository']) ? $this->services['App\Repository\TaskRepository'] : $this->load(__DIR__.'/getTaskRepositoryService.php')) && false ?: '_'};
}))));
