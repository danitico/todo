...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\TaskType' => function () {
    return ${($_ = isset($this->services['App\Form\TaskType']) ? $this->services['App\Form\TaskType'] : $this->services['App\Form\TaskType'] = new \App\Form\TaskType()) && false ?: '_'};
